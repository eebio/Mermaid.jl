module Growth
    ...
    function get_growth_model()
        ...
        growth = @reaction_network begin
            ...
            @variables λ(t) [irreducible = true] ν_imp(t) [irreducible = true] M(t) [irreducible = true]
    ...
    u0_steady_state = [:λ => 0.6097342583114459, :M => 9.9988713e7, :ν_imp => 6.10236e7, :mᵣ => 105.0, :mₜ => 16.0, :mₘ => 16.0, :mₕ => 747.0, :sᵢ => 128.0, :a => 22.0, :pᵣ => 1218.0, :pₜ => 4623.0, :pₘ => 4623.0, :pₕ => 214477.0, :cᵣ => 1049.0, :cₜ => 44.0, :cₘ => 44.0, :cₕ => 2052.0]
    ...
    function ode_growth()
        ...
        return ODEProblem(growth, u0_steady_state, tspan, ps; structural_simplify=true, mtkcompile=true)
    end
end
